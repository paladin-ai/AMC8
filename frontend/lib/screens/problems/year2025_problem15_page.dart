...
class Y2025Problem15Page extends StatefulWidget {
  const Y2025Problem15Page({super.key});

  @override
  State<Y2025Problem15Page> createState() => _Y2025Problem15PageState();
}

class _Y2025Problem15PageState extends State<Y2025Problem15Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 15"),
