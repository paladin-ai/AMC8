...
class Y2025Problem20Page extends StatefulWidget {
  const Y2025Problem20Page({super.key});

  @override
  State<Y2025Problem20Page> createState() => _Y2025Problem20PageState();
}

class _Y2025Problem20PageState extends State<Y2025Problem20Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 20"),
