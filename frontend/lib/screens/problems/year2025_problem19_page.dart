...
class Y2025Problem19Page extends StatefulWidget {
  const Y2025Problem19Page({super.key});

  @override
  State<Y2025Problem19Page> createState() => _Y2025Problem19PageState();
}

class _Y2025Problem19PageState extends State<Y2025Problem19Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 19"),
