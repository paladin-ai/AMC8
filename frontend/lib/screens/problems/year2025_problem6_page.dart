...
class Y2025Problem6Page extends StatefulWidget {
  const Y2025Problem6Page({super.key});

  @override
  State<Y2025Problem6Page> createState() => _Y2025Problem6PageState();
}

class _Y2025Problem6PageState extends State<Y2025Problem6Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 6"),
        leading: IconButton(
