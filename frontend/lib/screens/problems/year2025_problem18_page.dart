...
class Y2025Problem18Page extends StatefulWidget {
  const Y2025Problem18Page({super.key});

  @override
  State<Y2025Problem18Page> createState() => _Y2025Problem18PageState();
}

class _Y2025Problem18PageState extends State<Y2025Problem18Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 18"),
