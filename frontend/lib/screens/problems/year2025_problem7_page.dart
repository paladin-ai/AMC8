...
class Y2025Problem7Page extends StatefulWidget {
  const Y2025Problem7Page({super.key});

  @override
  State<Y2025Problem7Page> createState() => _Y2025Problem7PageState();
}

class _Y2025Problem7PageState extends State<Y2025Problem7Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 7"),
