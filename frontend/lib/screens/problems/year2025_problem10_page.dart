...
class Y2025Problem10Page extends StatefulWidget {
  const Y2025Problem10Page({super.key});

  @override
  State<Y2025Problem10Page> createState() => _Y2025Problem10PageState();
}

class _Y2025Problem10PageState extends State<Y2025Problem10Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 10"),
