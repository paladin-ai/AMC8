...
class Y2025Problem3Page extends StatefulWidget {
  const Y2025Problem3Page({super.key});

  @override
  State<Y2025Problem3Page> createState() => _Y2025Problem3PageState();
}

class _Y2025Problem3PageState extends State<Y2025Problem3Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 3"),
        leading: IconButton(
