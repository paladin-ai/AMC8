// From frontend/: dart run tool/patch_app_language.dart
import 'dart:io';

void main() {
  final scriptDir = File(Platform.script.toFilePath()).parent;
  final problemsDir = Directory(
    '${scriptDir.parent.path}${Platform.pathSeparator}lib${Platform.pathSeparator}screens${Platform.pathSeparator}problems',
  );
  if (!problemsDir.existsSync()) {
    stderr.writeln('Missing problems dir: ${problemsDir.path}');
    exit(1);
  }

  final files = problemsDir
      .listSync()
      .whereType<File>()
