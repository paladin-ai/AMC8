...
class Y2025Problem23Page extends StatefulWidget {
  const Y2025Problem23Page({super.key});

  @override
  State<Y2025Problem23Page> createState() => _Y2025Problem23PageState();
}

class _Y2025Problem23PageState extends State<Y2025Problem23Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 23"),
