...
class Y2025Problem12Page extends StatefulWidget {
  const Y2025Problem12Page({super.key});

  @override
  State<Y2025Problem12Page> createState() => _Y2025Problem12PageState();
}

class _Y2025Problem12PageState extends State<Y2025Problem12Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 12"),
