...
class Y2025Problem1Page extends StatefulWidget {
  const Y2025Problem1Page({super.key});

  @override
  State<Y2025Problem1Page> createState() => _Y2025Problem1PageState();
}

class _Y2025Problem1PageState extends State<Y2025Problem1Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 1"),
        leading: IconButton(
