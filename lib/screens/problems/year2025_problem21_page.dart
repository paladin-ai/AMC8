...
class Y2025Problem21Page extends StatefulWidget {
  const Y2025Problem21Page({super.key});

  @override
  State<Y2025Problem21Page> createState() => _Y2025Problem21PageState();
}

class _Y2025Problem21PageState extends State<Y2025Problem21Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 21"),
