...
class Y2025Problem4Page extends StatefulWidget {
  const Y2025Problem4Page({super.key});

  @override
  State<Y2025Problem4Page> createState() => _Y2025Problem4PageState();
}

class _Y2025Problem4PageState extends State<Y2025Problem4Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 4"),
        leading: IconButton(
