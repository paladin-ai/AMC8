...
class Y2025Problem14Page extends StatefulWidget {
  const Y2025Problem14Page({super.key});

  @override
  State<Y2025Problem14Page> createState() => _Y2025Problem14PageState();
}

class _Y2025Problem14PageState extends State<Y2025Problem14Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 14"),
