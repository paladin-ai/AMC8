...
class Y2025Problem22Page extends StatefulWidget {
  const Y2025Problem22Page({super.key});

  @override
  State<Y2025Problem22Page> createState() => _Y2025Problem22PageState();
}

class _Y2025Problem22PageState extends State<Y2025Problem22Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("2025 Problem 22"),
